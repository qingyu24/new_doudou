...
public enum eLogicDebugLogType implements LogType {
    ...
    public String Serialize() {
        switch (this) {
            case LOGIC_INFO_EXCEL_START_READ:
                return "开始读取[%s][%s]";
            case LOGIC_INFO_EXCEL_READ_FINISH:
                return "读取完成[%s][%s]";
            case LOGIC_TASK_REFRESH_DATA:
                return "刷新标识(%d)";
            case LOGIC_TASK_REFRESH_NO_NEED:
                return "标识一样无需刷新";
            case LOGIC_TASK_REFRESH_ALL_DATA:
                return "刷新所有的任务数据";
            case LOGIC_TASK_RECEIVE:
                return "要接收任务(%d)";
            case LOGIC_TASK_GIVEUP:
                return "要放弃任务(%d)";
            case LOGIC_TASK_FINISH:
                return "要完成任务(%d)";
            case LOGIC_TASK_SYN_OPER:
                return "SynOper(%s)(%d)";
            case LOGIC_FACTION_BOSS_ACTIVITY_STATUS:
                return "旅团BOSS活动(%d)(%s)";
            case LOGIC_FACTION_BOSS_ACTIVITY_TIME:
                return "旅团BOSS活动(%s)(%s)";
            case LOGIC_SQL_RECORD:
                return "玩家记录:%d : %s";
            default:
