...
//		case MEMBERLIST: return 8;
            ...
            // 采石场水晶相关
            case ST_GETQUARRYDATA:
                return 10;
            case ST_GET:
                return 11;                ///< 拾取水晶
            case GETPAYURL_RESULT:
                return 12;        // 返回充值网址结果
            ...
            case ST_BUYCRYSTAL:
                return 17;        ///< 购买获得水晶
            case ST_GETCRYSTALDATA:
                return 18;    ///< 获取水晶界面数据
            case ST_NOTICE:
                return 19;            ///< 浮字提示
            case ST_APPRAISE_RESULT:
                return 20;    ///< 注魔结果
            ...
            case POSTAWARD:
                return 22;            ///< 邮寄奖励数据
            case POSTAWARDNOTICE:
                return 23;    ///< 邮寄奖励数据
            case RESTDATA:
                return 24;            ///< 休息信息

            case ONCESAODANGRECK_OK:
                return 25;    ///< 扫荡成功
            case ONCESAODANGRECK_FAIL:
                return 26;    ///< 扫荡失败
            case RESTEXP:
                return 27;            ///< 休息经验增加
            case ENDSAODANGRECK:
                return 28;        ///<扫荡结束
            case JINSIQUESENDTIMES:
                return 29;    ///<金丝雀的今日已购次数
            case FEEDJINSIQUERES:
                return 30;    ///<喂养金丝雀的结果

            case SYSTEMNOTICE:
                return 31;        ///<系统通告

            case MSGBOXGUIDER_REFRESH:
                return 32;
            case MSGBOXGUIDER_ENDONE:
                return 33;
            case GETJIHUOAWARD_RESULT:
                return 34;

            case SYSTEMTOPNOTICE:
                return 35;
            case TREASUREHUNT_RESULT:
                return 36;
            case GetTREASURERMAPCD:
                return 37;
            case GetTREASURERMAP_RESULT:
                return 38;
            case PAYSUBSTITUTE_SUCCESS:
                return 39;
            case GETZZZPRIZEITEMCID_RESULT:
                return 40;
            case STARTSAODANG_SUCCESS:
                return 41;

            case RUNE_ANSWER_GRIDINFO:
                return 42;    ///<
            case RUNE_ANSWER_SWAP:
                return 43;
            case RUNE_ANSWER_UNLOCK:
                return 44;
            case RUNE_ANSWER_INLAY:
                return 45;
            case RUNE_ANSWER_BAGINFO:
                return 46;
            case RUNE_ANSWER_ADD:
                return 47;
            case RUNE_ANSWER_DEL:
                return 48;
            case RUNE_ANSWER_Unload:
                return 49;
            case RUNE_ANSWER_COMPOUD:
                return 50;

            //case YDZZ_QUERY:			return 51;				//云端之战_查询
            case YDZZ_ENTERFAILED:
                return 52;                //云端之战_进入战斗
            //case YDZZ_REVIVE:			return 53;				//云端之战_复活

            case RUNE_ANSWER_QUREY:
                return 54;

            case COLLECTION_QUERY:
                return 55;
            case COLLECTION_GOTOCOLLECT:
                return 56;
            case COLLECTION_COLLECTFailed:
                return 57;
            case COLLECTION_UNLOCK:
                return 58;

            case YDZZ_ENTER_SUCESS:
                return 59;                //云端之战_进入战斗
...
//		case FactionPrayGodLvUp:	return 64;		
            case BlessingNum_Change:
                return 65;

            case COLLECTION_COLLECTSuccess:
                return 66;
...
//		case FACTIONTRANSFER:		return 71;
            ...
            case FashionItemList:
                return 76;
            case FashionDressingData:
                return 77;
            case FashionGet:
                return 78;
            case FahsionDress:
...
//		case Faction_EradDevilOK: 	return 85;		//除魔成功
            ...
            case MzProgress_Reward_Answer:
                return 90;    //领取历程奖励反馈
            case MzProgress_Refresh:
                return 91;    //请求刷新历程数据
            case MzProgress_Single_Active:
                return 92;    //某一历程完成

            case Promotion_list_Append:
                return 99;        //
            case Item_Limited:
                return 100;        //物品购买或使用受限
            case Repay_Award_Res:
                return 101;        //领取补偿礼包反馈
...
//		
            ...
            case Award_OverFlowInfo:
                return 110;
            case Award_BuyOverFlowGiftRes:
                return 111;
            case Award_OnFirstPay:
                return 112;
            case Award_GetFirstPayAwardRes:
                return 113;


            case JEWELRY_ANSWER_ITEMLIST:
                return 114;//获取物品列表
            case JEWELRY_ANSWER_FIGHTSOUL:
                return 115;//获取物品背包中饰品个数
            case JEWELRY_ANSWER_CHARSDATA:
                return 116;    //获取关联的角色饰品
            case JEWELRY_ANSWER_NEWADDITEMS:
                return 117;    //获取联合会角色饰品
            case JEWELRY_ANSWER_RAISE:
                return 118;    //获取联合会角色饰品
            case JEWELRY_ANSWER_DECOMPOSE:
                return 119;    //获取联合会角色饰品
            /////////////////////////////////////////////////////
            case Promotion_list:
                return 120;
            case Promotion_Reward_Answer:
                return 121;
            case Add_Multi_Res:
                return 125;
            case Hell_Add_Multi_Res:
                return 124;

            case DELPOSTAWARD:
                return 126;
            case JEWELRY_ANSWER_SMELT:
                return 122;    ////战场勋章熔炼
            case RUNE_ANSWER_MULTI_GRIDINFO:
                return 123;    ///<
            case RUNE_ANSWER_ALLATTR_BAGINFO:
                return 124;
            case RUN_ANSWER_CHANGE:
                return 125;
            case ACTIVEOPENID:
                return 126;
        }
