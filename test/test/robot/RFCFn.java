...
public class RFCFn
{
	...
	public static void CenterImpl_creatRoomRule(Robot r, int p_user, int isTeam, int gameTime, int teNumber, String eachSize, int roomName)
	{
		r.GetSendBuffer().Clear().AddID(3,13).Add(p_user).Add(isTeam).Add(gameTime).Add(teNumber).Add(eachSize).Add(roomName).Send(r.GetLink());
	}
